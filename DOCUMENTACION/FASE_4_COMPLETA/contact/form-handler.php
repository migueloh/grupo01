...
//$use_smtp = '0';
$emailto = 'gestionesiker@gmail.com';
	...
	$message = '';
	$response = '';
	$response_fail = 'Se produjo un error en la verificación de sus datos.';
...
$url="../enviadook.html";
		//header( "Location: $url" );
		echo("<script>location.href = 'http://limpiezaslacolombiana.com/enviadook.html'</script>");
		/*echo("<script>location.href = 'http://limpiezaslacolombiana.com/contact.html'</script>");*/
	//echo $response;
...
function sendEmail($subject, $content, $emailto, $emailfrom) {
	...
	$from = $emailfrom;
	//$response_sent = 'Gracias. Su mensaje se ha enviado correctamente.';
	$response_error = 'Error. Por favor, inténtalo de nuevo.';
